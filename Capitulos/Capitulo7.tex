...
Se ha observado que al realizar las grabaciones con expertos en capoeira, el dispositivo \texttt{Kinect} captura el movimiento de una forma correcta. Además, su uso doméstico a bajo coste posibilita un mayor alcance entre el público.
...
Por otro lado, se plantea la necesidad de incluir métodos más sofisticados para el análisis de los movimientos, similares a los usados en \cite{Keerthy:Thesis:2012,Kyan:2015:ABD:2753829.2735951} para permitir un análisis más fino de los movimientos que pueda proporcionar resultados de mayor utilidad para practicantes avanzados de capoeira.
