...
Paralelamente, \texttt{Raúl}, el otro integrante del grupo, investigó como darle vida a los personajes del proyecto, con el objetivo de desarrollar diferentes avatares con una estética humana. La primera aplicación que utilizó para ese propósito fue \texttt{MakeHuman}, ya que mostraba una interfaz amigable e intuitiva. Creó varios avatares, pero el inicial fue muy sencillo (véase Figura \ref{fig:makehuman_avatar}), ya que de momento le interesaba ver el resultado que proporcionaba esta aplicación junto con el \textit{cubeman}. De los diferentes avatares creados, uno de ellos fue el que se utilizó en un principio (véase Figura \ref{fig:makehuman_avatar_huesos3}). Al observar que este avatar no plasmaba el realismo esperado, decidió buscar otro software que pudiera realizar esta tarea. En la busqueda, encontró varias aplicaciones como \texttt{Blender} y \texttt{MarvelousDesigner}, las cuales al final no fueron utilizadas. Una de ellas, debido a su alta curva de aprendizaje para las necesidades dadas y la otra,  no conseguía ser compatible de forma correcta con los formatos de las otras aplicaciones utilizadas. Por esta razón, siguió buscando un \textit{software} que pudiera modelar los personajes de una forma correcta y en el camino halló \texttt{Mixamo}. Una compañia que ofrece una aplicación llamada \texttt{Fuse Character Creator de Mixamo} que sirve  para el desarrollo de personajes 3D, y a su vez, un entorno dedicado a la animación de personajes. De modo que decidió cambiar a esta nueva aplicación, ya que se amoldaba perfectamente a las necesidades de este proyecto.

Como base para realizar los personajes, los dos integrantes del grupo, asistieron a una de las clase semanales que imparten en las instalaciones de la Universidad Complutense de Madrid. De este modo, observaron las caracteristicas de los integrantes de la escuela \texttt{Abadá-Capoeira} y la vestimenta que portaban para realizar los entrenamientos.

Con toda esta información, el integrante Raúl, creó los avatares del proyecto, como son el alumno, profesor y los dos animadores que se encuentran en el fondo del escenario de la isla. Además diseñó la rópa tipica de capoeira para los personajes, como son el pantalón largo y la camiseta de tirantes de color blanco. Cuando terminó el modelado de los avatares, inició el proceso para incorporar animaciones a los personajes del fondo de la escena de la isla, como son los animadores.

Antes de unir el trabajo realizado con el integrante Víctor, Raúl diseño la interfaz de tipo UI, pudiendo realizar diferentes transiciones en la aplicación VIC, empezando en la escena de inicio, hasta llegar al entrenamiento y su posterior análisis.
...
Por ultimo, con la actuación de ambos componentes del grupo, se hicieron grabaciones con la gente experta de la escuela \texttt{Abadá-Capoeira}. Las grabaciones tuvieron una duración de dos días, y gracias a esto, se obtuvieron todas las muestras posibles que la tecnología de captura de movimiento de \texttt{Kinect} permitió grabar de una manera aceptable. Después se ajustaron y catalogaron los movimientos para poder incorporarlos al proyecto.
