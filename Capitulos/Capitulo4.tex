...
\comImpl{Terminar con alguna imagen}
...
El hardware principal usado en este proyecto es el dispositivo de captura de movimiento \textit{Kinect v2} \cite{Kinectv2} y el cable adaptador para Windows \citep{adaptadorKinect}.

\subsection{Kinect versión 2}

%
Se trata de un periférico que permite a los usuarios interactuar con la aplicación, de modo que gracias a sus sensores, no tiene la necesidad de utilizar algún tipo de mando inalambrico. Este dispositivo se documenta en la sención \ref{Kinect} del proyecto.
%

%
Pasados unos años tras la salida de Kinect, en 2014 Microsoft \textcolor{red}{se dió cuenta} que liberando el controlador, podría sacarle un mayor rendimiento a esta tecnología. De modo que facilitó su uso en multiples aplicaciones, como en el caso de la captura de movimientos. 

Para poder utilizar este dispositivo en un ordenador, Microsoft liberó el SDK para entornos Windows, necesario ,

de modo que se empezó a utilizar en multiples aplicaciones, como en el caso de la captura de movimientos. 


%
En cuanto al uso de este dispositivo en un ordenador, Microsoft libero? los drivers para facilitar su aplicacio?n en entornos Windows, popularizando asi? su uso en mu?ltiples aplicaciones, tales como la captura de movimiento.

%

%

Para aquellas aplicaciones que usarán de forma habitual el seguimiento de cuerpo de Kinect para Windows v2, además del procesamiento de aplicaciones personalizadas te recomendamos que uses la siguiente configuración del equipo como referencia. Esto no solo te proporcionará un rendimiento extraordinario en los escenarios de seguimiento más difíciles, sino que también te permitirá procesar aplicaciones adicionales a la vez que mantienes una velocidad de fotogramas óptima.
