...
El software principal utilizado en este proyecto es Unity 5.5 \cite{Unity_Manual}, que es un motor de desarrollo de videojuegos.
Para la edición , compilación y depuración de la programación de Unity se ha utilizado Visual Studio 2015 \cite{VSMS} con el lenguaje de programación C\#.\\
\\
...
Los entornos a elegir fueron Visual Studio 2015 \cite{VSMS}, Unity \cite{Unity} y Unreal Engine \cite{Unreal}. El primero descartado fue Visual Studio 2015 porque se busca crear también un escenario 3D y, tanto Unity como Unreal ,ofrecen herramientas útiles para la creación de estos escenarios.\\\\
...
La ejecución de pruebas del juego se realiza por medio del \textit{Play mode} situado en el panel sexto. Esta funcionalidad permite poner en funcionamiento el juego , pararlo y detener su ejecución, siendo esto, fundamental para comprobar y depurar un juego \cite{Unity_Manual}.\\
