...
Estos sistemas utilizan emisores que generan pulsos ultrasónicos, capturados por uno o varios receptores situados en posiciones predefinidas, permitiendo averiguar la posición y orientación del emisor situado en el escenario. El inconveniente de esta tecnología se debe a que los emisores son demasiado voluminosos y además no son capaces de capturar de una forma correcta movimientos bruscos. Sin embargo, permite obtener un ahorro importante respecto a otros sistemas, rondando un precio de 2.500\euro.

\subsection{Captura de movimiento mediante sistemas inerciales}

\subsection{Seguimiento de ojos}
