...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth, height=0.2\textheight]{Imagenes/Capitulos/2/ETG-2w}
...
\begin{figure}[h!]
	\centering
	\subfloat[Wii Remote]{\includegraphics[width=0.3\textwidth,height=0.2\textheight]{Imagenes/Capitulos/2/wii_remote}\label{fig:wiiremote}}
	\hspace{0.5cm}
	\subfloat[Barra sensor ]{\includegraphics[width=0.45\textwidth,height=0.17\textheight]{Imagenes/Capitulos/2/barra_sensor}\label{fig:barrasensor}}
	\caption{Dispositivos de Nintendo Wii}\label{fig:dispositivosdenintendo}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\subfloat[PlayStation Move]{\includegraphics[width=0.3\textwidth,height=0.2\textheight]{Imagenes/Capitulos/2/playstation-move}\label{fig:playstation-move}}
	\hspace{0.5cm}
	\subfloat[PlayStation Eye]{\includegraphics[width=0.45\textwidth,height=0.17\textheight]{Imagenes/Capitulos/2/playstation-eye}\label{fig:playstation-eye}}
	\caption{Dispositivos de Sony PlayStation}\label{fig:dispositivosdesony}
\end{figure}
