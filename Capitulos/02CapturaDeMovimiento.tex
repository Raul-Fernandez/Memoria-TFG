...
El principal inconveniente de este sistema, es la luz y los colores de fondo. Ya que, se vuelve inu?til teniendo una luz de fondo del mismo color que el dispositivo PlayStation Move, perdiendo por completo la posicio?n de los marcadores. En la actualidad, es el sistema con menor estabilidad en la captura de movimientos en los videojuegos.


\subsection{Microsoft, Kinect}

Por otra parte, en 2010 Microsoft desarrolló \texttt{Kinect} para Xbox 360, en sus inicios conocido como \textit{Project Natal}. Después de unos años, Microsoft ofreció la posibilidad de conectar \texttt{Kinect v2} por medio de ordenadores, con el sistema operativo Windows 8 o superior mediante usb 3.0. Se trata de un perife?rico para videojuegos que prescinde de mandos gracias a un sensor de deteccio?n de movimientos. Este sistema reconoce el rostro, la voz, los movimientos y gestos de los jugadores, mediante una cámara conectada a la videoconsola. 
...
Otro proyecto con una terapia mas especificas es \citep{sin2013additional}, que estudia los efectos de un entrenador virtual para los paciente con hemiplejía, haciendo enfasis en la función de las extremidades superiores, incluyendo el rango de movimiento, la función motora y la destreza manual.......
