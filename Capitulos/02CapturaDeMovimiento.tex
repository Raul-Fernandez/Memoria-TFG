...
Un sistema magnético estándar consta de 18 sensores, una unidad de control electrónica y un software para el procesamiento. En cambio, un sistema de última generación puede tener hasta 90 sensores capaces de capturar hasta 144 muestras por segundo, teniendo un coste medio\footnote{Entorno a 4.000 y 11.000 ?}.
...
Los sistemas ópticos emplean los datos recogidos por sensores de imagen para obtener la posición de un elemento en el espacio, utilizando \textit{markers}\footnote{Indicadores} pegados al cuerpo del actor, aunque los sistemas modernos permiten recoger los datos rastreando la superficie de forma dinámica. 

Estos sistemas permiten la grabación en tiempo real, ya que utilizan un ordenador que recibe la entrada de una o mas cámaras digitales CCD\footnote{Charge-coupled device} sincronizadas produciendo proyecciones simultáneas. Habitualmente se utilizan entorno a 4 o 32 cámaras, siempre y cuando no se añadan de forma innecesarias, ya que complicarían el procesamiento de la información.
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth, height=0.3\textheight]{Imagenes/Capitulos/2/mocap_indicadorespasivos2}
	\caption{Sistema de captura de movimiento óptico con indicadores pasivos}
	\label{fig:mocapindicadorespasivos2}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.4\linewidth, height=0.3\textheight]{Imagenes/Capitulos/2/mocap_indicadorespasivos3}
	\caption{Sistema de captura de movimiento óptico con indicadores pasivos}
	\label{fig:mocapindicadorespasivos3}
\end{figure}
