...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth, height=0.25\textheight]{Imagenes/Capitulos/2/ETG-2w}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.4\linewidth, height=0.18\textheight]{Imagenes/Capitulos/2/wii_remote}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.45\linewidth, height=0.2\textheight]{Imagenes/Capitulos/2/barra_sensor}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.4\linewidth, height=0.18\textheight]{Imagenes/Capitulos/2/playstation-move}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.5\linewidth, height=0.2\textheight]{Imagenes/Capitulos/2/playstation-eye}
