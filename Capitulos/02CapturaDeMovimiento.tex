...
Como ejemplo de investigación en esta tecnología, la empresa SMI (Senso Motoric Instruments)\footnote{https://www.smivision.com/eye-tracking/product/eye-tracking-glasses/} ha desarrollado una gafa (véase Figura \ref{fig:etg-2w}) que permite el seguimiento de los ojos y combinado con la ca?mara, detecta el? punto exacto donde está detenienda la mirada. Soportando el acceso de datos en tiempo real y el control de usuario a través de una conexión inalámbrica. 
