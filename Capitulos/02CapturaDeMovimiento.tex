...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth, height=0.5\textheight]{Imagenes/Capitulos/2/mocap_fibraoptica}
	\caption{Sistema de captura de movimiento mediante fibra óptica}
	\label{fig:mocapfibraoptica}
\end{figure}


\subsection{Captura de movimiento mediante ultrasonidos}

Este sistema utiliza emisores que generan pulsos ultrasónicos (imperceptible por el ser humano) capturados por uno o varios receptores (a modo de radar), permitiendo averiguar la posición del emisor en el escenario, incluso en algunos casos, su orientación. La desventaja de estos sistemas es que son demasiado voluminosos, siendo incapaces de trabajar con movimientos bruscos. Aunque en comparación con otros sistema de captura de movimiento, el precio supone una gran ventaja, ya que ronda los 2500 \euro.

\subsection{Captura de movimiento mediante sistemas inerciales}

Con el objetivo de capturar el movimiento, los sistemas inerciales emplean sensores (como giroscopios y acelerómetros) con el propósito de obtener información sobre la velocidad angular y la aceleración del sensor. Con estos datos, es posible establecer la velocidad angular, la posición y el eje de giro. La información obtenida de los sensores, se transmite a un ordenador donde se puede observar el movimiento capturado sobre una figura ya animada. 
...
%%% TeX-master: "../Tesis.tex"
%%% End:
>>>>>>> 754cdada76d37e63deaec28c5bdef9790574f273
