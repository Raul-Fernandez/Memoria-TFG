...
Posteriormente se elaboran una serie de escenas en \texttt{Unity} que servirán de interfaz para la aplicación. En las diferentes escenas encuentran la escena de inicio, el menú principal, escena de ayuda, escena de créditos, etc. En cada escena se ha creado un entorno diferenciado para cada una de las necesidades dadas.
...
\begin{itemize}
	...
	\item \textit{PhysicsDemo}, muestra un simulación de físicas que capta el movimiento del brazo para lanzar una pelota virtual.
...
\subsection{Implementacione de la comparación del movimiento}
...
\subsection{Implementación de avatares y escenarios}
...
\subsection{Implementación del análisis del movimiento}
