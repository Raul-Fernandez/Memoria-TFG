...
Una vez elegida la tecnolog?a y plataformas que se van a utilizar se empieza preparar el desarrollo del proyecto. En primer lugar se investigan que librer?as y paquetes se necesitan para tener una buena conexi?n con kinect y que información obtenida del sensor de movimiento podemos aprovechar para el proyecto.
