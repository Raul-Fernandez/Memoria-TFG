...
En esta escena, se seleccionará el tipo de usuario que utilizará la aplicación. Dependiendo de la selección, el usuario accederá como alumno para entrenar o como profesor para grabar algún movimiento nuevo.
\begin{figure}[h!]
	\centering
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\linewidth, height=0.4\textheight]{Imagenes/Capitulos/capitulo5/Profesor}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\linewidth, height=0.4\textheight]{Imagenes/Capitulos/capitulo5/Alumno}
