...
\begin{figure}[th!]
	\centering
	\includegraphics[width=0.5\linewidth]{Imagenes/Capitulos/capitulo5/ejemplo_txt}
...
\subsubsection{Escenario de gimnasio}
La creación de escenario del gimnasio se creó a partir de diferentes componentes,  distribuidos en distintos paquetes, ofrecidos en el \texttt{Asset Store} de \texttt{Unity}. En el diseño de suelo se creo un \texttt{Gameobject} tipo panel y  se le incrusto un material ofrecido por el paquete \texttt{Yughues Free Wooden Floor Materials}\footnote{https://www.assetstore.unity3d.com/en/\#!/content/13213}, para simular un suelo de madera. En la construcción de las paredes del escenario se crearon tres paneles, colocándoles de forma vertical formando un cubo abierto, y ademas, se añadió a todos los paneles, un material del paquete \texttt{18 High Resolution Wall  Textures}\footnote{https://www.assetstore.unity3d.com/en/\#!/content/12567} que se asemejan a una textura tipo piedra. Se colocan unos bancos y un casillero para que de sensación de ser una sala de entrenamiento, estos objetos son modelos del paquete \texttt{Locker Room Props}\footnote{https://www.assetstore.unity3d.com/en/\#!/content/3355}. Para no dar una impresión de una habitación cerrada se añaden dos ventanas y un ventilador , estos objetos vienen implementados en el paquete \texttt{Props for the Classroom}
\footnote{https://www.assetstore.unity3d.com/en/\#!/content/5977},se observó también que en el mismo paquete tenia un objeto con la forma de una pizarra de clase, entonces para agregar una huella educativa se añadió este elemento a escena.
\comImpl{imagen del primer escenario}
\subsubsection{Escenario de isla}
...
\subsubsection{Movimientos grabados}
...
\subsubsection{Elección y ajuste de movimientos}
